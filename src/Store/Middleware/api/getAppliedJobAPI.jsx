...
export const appliedJobApi = createApi({
  reducerPath: "appliedJobApi",
  ...
  endpoints: (builder) => ({
    appliedJobapi: builder.query({
      query: () => `/user/applied/all-job`,
    }),
  }),
});

export const { useAppliedJobapiQuery } = appliedJobApi;
